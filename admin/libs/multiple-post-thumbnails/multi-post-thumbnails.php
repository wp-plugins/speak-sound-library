...
if (!class_exists('MultiPostThumbnails')) {
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts( $hook ) {
			...
			if (version_compare($wp_version, '3.5', '<')) {	
				add_thickbox();
				wp_enqueue_script( "mpt-featured-image", WP_PLUGIN_URL.'/sound-manager/multiple-post-thumbnails/js/multi-post-thumbnails-admin.js', array( 'jquery', 'media-upload' ) );
			} else { // 3.5+ media modal
				wp_enqueue_media();
				wp_enqueue_script( "mpt-featured-image", WP_PLUGIN_URL.'/sound-manager/multiple-post-thumbnails/js/multi-post-thumbnails-admin.js', array( 'jquery', 'set-post-thumbnail' ) );
				wp_enqueue_script( "mpt-featured-image-modal", WP_PLUGIN_URL.'/sound-manager/multiple-post-thumbnails/js/media-modal.js', array( 'jquery', 'media-models' ) );				
			}
		}
